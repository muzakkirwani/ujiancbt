...
class SoalController extends Controller
{
    ...
    {
        $bankSoal = BankSoal::forTeacher(auth()->id())->findOrFail($bank_soal_id);
        $soals = Soal::where('bank_soal_id', $bank_soal_id)->orderBy('id', 'asc')->get();

        return view('pengawas.bank_soal.soal', compact('bankSoal', 'soals'));
    }
    ...
    public function store(Request $request, $bank_soal_id)
    {
        ...
        return redirect()->route('pengawas.bank_soal.soal.index', $bankSoal->id)->with('success', 'Soal berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, $bank_soal_id, $id)
    {
        ...
        return redirect()->route('pengawas.bank_soal.soal.index', $bank_soal_id)->with('success', 'Soal berhasil diperbarui!');
    }
    ...
    public function destroy($bank_soal_id, $id)
    {
        ...
        return redirect()->route('pengawas.bank_soal.soal.index', $bank_soal_id)->with('success', 'Soal berhasil dihapus!');
    }
    ...
    public function import(Request $request, $bank_soal_id)
    {
        ...
        return redirect()->route('pengawas.bank_soal.soal.index', $bankSoal->id)
            ->with('success', "Import selesai: $success berhasil, $failed gagal (pastikan format CSV benar).");
    }
